    ...
    try:
        ...
        for record in attendance_records:
            ...
            attendance_list.append({
                ...
                "marked_at": record.created_at.isoformat() if record.created_at else None
            })
        ...
        for user in users:
            ...
            if not category or category == "quizzes":
                ...
                for att in attempts:
                    ...
                    writer.writerow([
                        att.submitted_at.isoformat() if att.submitted_at else (att.started_at.isoformat() if att.started_at else ""),
